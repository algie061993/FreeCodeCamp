...
const originalText = (resultParagraph.innerHTML =
  "Select a story to begin <br /> The story be gone in 5 seconds");
...
function displayStory(genre) {
  ...
  setTimeout(() => {
    resultParagraph.innerHTML = originalText;
    storyContainer.style.borderColor = "initial";
  }, 5000);
}
